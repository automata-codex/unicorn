...
**Unicorn** is the monorepo for [Automata Codex](https://automatacodex.com). It contains **Zoltar**, an AI GM-in-a-box for solo tabletop RPGs — a consequence engine that enforces rules, hides information, and applies pressure without pulling punches.

Licensed under the Elastic License 2.0. Bring your own Anthropic API key and run it yourself. Managed hosting and multi-tenancy are not included in this repo.
